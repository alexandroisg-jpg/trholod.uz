...
export function DemoBar(){return <div className="demo-bar"><span className="wrap">Демонстрационный каталог <span className="demo-divider">/</span> Тестовые цены и остатки · без реальных покупок</span></div>}
...
export function Footer(){return <footer><div className="wrap footer-main"><Logo/><div><strong>Склад TR HOLOD</strong><p><MapPin size={16}/> Ташкент, Яккасарайский район,<br/>массив Башлык, 6/1</p></div><div><a href="/orders">Мои заказы</a><a href="/admin">Управление магазином</a><a href="/credits">Источники фотографий</a></div></div><div className="wrap footer-bottom"><span>© 2026 ООО «TR HOLOD» · Демонстрационный каталог</span><span>Разработка ASIATECHNOSTROY</span></div></footer>}
